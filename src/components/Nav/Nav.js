...
export default function Nav({chilren, href}) {
    ...
    function linkTextStyle (linkname){

        if(lastClicked == linkname) {
    ...
    function changeState (state){
        ...
        if(state === "Home") scroll.scrollToTop();
    }

    
    return (
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            <Link onClick={() => changeState("Home")}>
                <div className="mr-16 relative group cursor-pointer">
                    <div className={linkTextStyle("Home")}>Home</div>
                    
                    <div className={linkIconStyle("Home") }>
            ...
            <Link to="about" smooth={true} duration={1000} onClick={() => changeState("About")} >
                <div className="mr-16 relative group cursor-pointer">
            ...
            <Link to="edu" smooth={true} duration={1000} onClick={() => changeState("Education")} >
                <div className="mr-16 relative group cursor-pointer">
            ...
            <Link to="experience" smooth={true} duration={1000} onClick={() => changeState("Experience")}  >
                <div className="mr-16 relative group cursor-pointer">
            ...
            <Link to="skills" smooth={true} duration={1000} onClick={() => changeState("Skills")}  >
                <div className="mr-16 relative group cursor-pointer">
            ...
            <Link to="portfolio" smooth={true} duration={1000} onClick={() => changeState("Portfolio")}  >
                <div className="mr-16 relative group cursor-pointer">
            ...
            <Link to="contact" smooth={true} duration={1000} onClick={() => changeState("Contact")}  >
                <div className="mr-16 relative group cursor-pointer">
                    <div className={linkTextStyle("Contact")}>Contact</div>
                    <div className={linkIconStyle("Contact") }>
