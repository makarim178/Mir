...
function Header() {
    return (
        ...
        <div id="home" className="container-fluid flex mt-20 items-center justify-between header-height-200vh p-4">
            <div className="p-10">
                ...
                <a href="http://triosdevelopers.com/~M.A.Karim/CPP2/Mir%20Ashiful%20Karim_Resume.pdf" target="_blank">
                    <div className="curser-pointer flex rounded-lg group border-blue-400 justify-center items-center text-center border-2 trasition delay-200 h-10 mt-4 md:h-16 md:mt-10 bg-blue-400 bg-opacity-20" style={{ backdropFilter : "blur(5px)"}}>
                        <div className="cursor-pointer text-sm font-thin md:text-2xl md:font-extrabold p-2 md:p-0">
                            View My Resume
                        </div>
